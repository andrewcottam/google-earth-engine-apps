...
require({
	...
	ready(function() {
		var geeServerUrl, geeImageServerUrl, axisMinx, axisMiny, currentAlgorithm = {}, points = [], algorithms = [], draftSites = [], legendClasses = [], siteData = [],   path_row = "", xAxis = 'value', yAxis = 'hue', xscale = 1, yscale = 360, xOffset = 0, yOffset = 0, IDENTIFY_RADIUS = 3, layersLoading = 0, canvasLayer, rgbLayer, hsvLayer, detectionLayer, siteLayer, draftsiteLayer, mapQueryLayer, axesLayer, triangulationLayer, queryLayer, algorithmLayer, spectralLayer, spectralMap, xAxisTitleGraphic, yAxisTitleGraphic, queryObject, currentTabId, currentUsername, loadTextDialog, previousExtent, scenePropertiesGrid, currentsceneid, currentscenedate, loadingOverlay, loginhandler, loggedIn, initExtent, map, restServerUrl, chart, showCursorValues = true, showAxes = true, textColor = new Color([64, 64, 64]), photoViewer;
		...
		function createSpectralMap() {
			...
			spectralLayer = new wmsFilterLayer(GEOSERVER_WMS_ENDPOINT, LAYER_NAME);
			...
			testLayer = new wmsFilterLayer(GEOSERVER_WMS_ENDPOINT, LAYER_NAME + "_complete");
